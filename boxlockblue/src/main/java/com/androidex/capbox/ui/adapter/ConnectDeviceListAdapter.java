...
public class ConnectDeviceListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(com.androidex.capbox.R.layout.item_devicelist, null);
            if (holder == null) {
             ...
             * 操作按钮层
             */
            holder.normalItemContentLayout = convertView.findViewById(com.androidex.capbox.R.id.rl_normal);
            holder.deviceName = (TextView) convertView.findViewById(com.androidex.capbox.R.id.device_name);
            holder.device_address = (TextView) convertView.findViewById(com.androidex.capbox.R.id.device_address);
