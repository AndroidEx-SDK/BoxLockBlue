...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            RLog.d("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    RLog.d(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            RLog.d(" Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            RLog.d(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
