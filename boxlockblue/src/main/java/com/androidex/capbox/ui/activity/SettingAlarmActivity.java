...
public class SettingAlarmActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    @Bind(com.androidex.capbox.R.id.tv_lowestTemp)
    TextView tv_lowestTemp;
    @Bind(com.androidex.capbox.R.id.tv_highestTemp)
    TextView tv_highestTemp;
    @Bind(com.androidex.capbox.R.id.tb_police)
    ToggleButton tb_police;
    @Bind(com.androidex.capbox.R.id.tb_distanceAlarm)
    ToggleButton tb_distanceAlarm;
    @Bind(com.androidex.capbox.R.id.tb_tamperAlarm)
    ToggleButton tb_tamperAlarm;
    @Bind(com.androidex.capbox.R.id.tb_tempAlarm)
    ToggleButton tb_tempAlarm;
    @Bind(com.androidex.capbox.R.id.tb_humAlarm)
    ...
    @OnClick({
            com.androidex.capbox.R.id.ll_lowestTemp,
            com.androidex.capbox.R.id.ll_highestTemp,
            com.androidex.capbox.R.id.tv_finish,
    })
    public void clickEvent(View view) {
        switch (view.getId()) {
            case com.androidex.capbox.R.id.ll_highestTemp://最高温
                ...
                break;
            case com.androidex.capbox.R.id.ll_lowestTemp://最低温
                Dialog.showAlertDialog(context, getResources().getString(com.androidex.capbox.R.string.setting_tv_lowtemp), new Dialog.DialogDataListener() {
                    @Override
                    public void confirm(String data) {
                        if (data != null && data != "") {
                ...
                break;
            case com.androidex.capbox.R.id.tv_finish:
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        ...
        switch (compoundButton.getId()) {
            case com.androidex.capbox.R.id.tb_police://报警开关
                if (isChecked) {
                    //选中
                    police = "A";
                ...
                break;
            case com.androidex.capbox.R.id.tb_distanceAlarm://距离报警开关
                if (isChecked) {
                    distancePolice = "A";
                    Log.e(TAG, "防拆报警A");
                ...
                break;
            case com.androidex.capbox.R.id.tb_tamperAlarm://防拆报警开关
                if (isChecked) {
                    dismountPolice = "A";
                    Log.e(TAG, "防拆报警A");
                    tb_police.setChecked(true);
                ...
                break;
            case com.androidex.capbox.R.id.tb_tempAlarm://温度报警开关
                if (isChecked) {
                    tempPolice = "A";
                    Log.e(TAG, "温度报警开关A");
                    tb_police.setChecked(true);
                ...
                break;
            case com.androidex.capbox.R.id.tb_humAlarm://湿度报警开关
                if (isChecked) {
                    humidityPolice = "A";
                    Log.e(TAG, "湿度报警开关A");
                    tb_police.setChecked(true);
    ...
    public int getLayoutId() {
        return com.androidex.capbox.R.layout.activity_settingalarm;
    }
