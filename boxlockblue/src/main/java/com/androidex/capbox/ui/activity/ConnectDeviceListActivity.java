...
public class ConnectDeviceListActivity extends BaseActivity {
    ...
    @Bind(com.androidex.capbox.R.id.device_list_connected)
    ListView listconnected;
    @Bind(com.androidex.capbox.R.id.swipe_searchDevices)
    ...
    private void initListView() {
        ...
        boxListAdapter = new ConnectDeviceListAdapter(context, allConnectDevice, new ConnectDeviceListAdapter.IClick() {
            ...
            public void listViewItemClick(int position, View v) {
                switch (v.getId()) {
                    case com.androidex.capbox.R.id.rl_normal:
    ...
    public int getLayoutId() {
        return com.androidex.capbox.R.layout.activity_connectdevicelist;
    }
}
