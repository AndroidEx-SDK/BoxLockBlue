...
public class AutoLinkTextView extends TextView {
    ...
    private void initWidth(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, com.androidex.capbox.R.styleable.AutoTextView);
        this.mMaxWidth = array.getDimensionPixelSize(com.androidex.capbox.R.styleable.AutoTextView_MaxWidth, 0);
