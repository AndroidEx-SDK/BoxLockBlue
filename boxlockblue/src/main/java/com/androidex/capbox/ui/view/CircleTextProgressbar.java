...
public class CircleTextProgressbar extends AppCompatTextView {
     ...
     * 进度倒计时时间。
     */
    private static long timeMillis = 3 * 1000;
    /**
     * 进度。
     */
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, com.androidex.capbox.R.styleable.CircleTextProgressbar);
        if (typedArray.hasValue(com.androidex.capbox.R.styleable.CircleTextProgressbar_in_circle_color))
            inCircleColors = typedArray.getColorStateList(com.androidex.capbox.R.styleable.CircleTextProgressbar_in_circle_color);
        else
